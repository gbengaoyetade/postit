...
describe('Signup', () => {
  ...
  it('should send error message when username contains special character except _',
  (done) => {
    const user = {
      fullName: 'gbenga Oyetade',
      username: '$gbenga_ps',
  ...
  it('should send error message when username is less than 2 characters',
  (done) => {
    const user = {
      fullName: 'gbenga Oyetade',
      username: 'g',
  ...
  it('should send error message when fullName field contians special characters',
  (done) => {
    const user = {
      fullName: 'gbenga Oyetade$$$',
      username: 'gbenga',
...
// Login tests
describe('Login', () => {
  it('should send error message when required fields are not available',
  (done) => {
  ...
  it('should send error message when username is correct but password is wrong',
  (done) => {
    const user = {
      username: 'apptest',
  ...
  it('should login user when the correct email is provided in the username field',
  (done) => {
    const userDetails = {
...
describe('Reset password', () => {
  it('Should send error message when password field is not provided',
  (done) => {
  ...
  it('Should send error message when invalid password is provided',
  (done) => {
  ...
  it('Should send error message when email address does not exist on postit',
  (done) => {
...
describe('server', () => {
  it('should return a 500 error when it cannot process .create on groupMembers',
  (done) => {
    const groupDetails = {
  ...
  it('should return a 500 error when it cannot process .create request',
  (done) => {
    const groupDetails = {
      groupName: 'group name 2',
      groupDescription: 'description' };
  ...
  it('should return a 500 error when it cannot process .find request',
  (done) => {
    const groupDetails = {
      groupName: 'group name 2',
      groupDescription: 'description' };
