...
describe('Create group', () => {
  ...
  it('should send error message when required fields are missing', (done) => {
    supertest(app)
      .post('/api/group')
      ...
      .end((err, res) => {
        ...
        assert.equal(
          res.body.error.groupDescription,
  ...
  it('Should send error message when group description field is not provided', (done) => {
  ...
  it('should create group when valid details are supplied', (done) => {
    ...
    supertest(app)
      ...
      .end((err, res) => {
        ...
        assert.equal(
          res.body.group.groupDescription,
...
describe('Add member', () => {
  ...
  it('should add user to a group when inputs are valid', (done) => {
  ...
  it('should send error message when user is already a member of the group', (done) => {
    const groupData = { userId: 2 };
    supertest(app)
      .post('/api/group/3/user')
      .set('x-access-token', token1)
...
describe('Leave group', () => {
  ...
  it('should remove user from group if he belongs to the group', (done) => {
    supertest(app)
      .delete('/api/group/2/leave')
      .set('x-access-token', token2)
      .send()
  ...
  it('should send error message when user is not a group member', (done) => {
    supertest(app)
      .delete('/api/group/2/leave')
      .set('x-access-token', token1)
      .send()
