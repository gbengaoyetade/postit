  ...
  it('should send error when required fields are missing', (done) => {
    supertest(app)
      ...
      .end((err, res) => {
        ...
        assert.equal(
          res.body.error.messageBody,
          'messageBody field is required'
        );
        assert.equal(
          res.body.error.messagePriority,
          'messagePriority field is required'
        );
        done();
      });
  });
  it('should send error message when messagePriority is not Normal, Urgent or Critical', (done) => {
    const message = {
...
describe('Get Messages', () => {
  it('should return status 200 and message when provided the right information', (done) => {
    supertest(app)
  ...
  it('should create message when priority is Urgent or Critical', (done) => {
    const message = {
      messageBody: 'this is a message',
  ...
  it('should return a 500 error when server cannot process .findAll request', (done) => {
  ...
  it('should return a 500 error when server cannot process .create() request', (done) => {
    const message = {
      messageBody: 'this is a message',
      messagePriority: 'Normal'
    };
  ...
  it('should return a 500 error when server cannot process groups.find() request', (done) => {
    const message = {
      messageBody: 'this is a message',
      messagePriority: 'Normal'
    };
